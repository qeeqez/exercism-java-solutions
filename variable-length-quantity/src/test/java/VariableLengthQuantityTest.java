...
public class VariableLengthQuantityTest {
    ...
    private final VariableLengthQuantity variableLengthQuantity =
        new VariableLengthQuantity();

    @Test
    public void testZero() {
        List<String> expected = List.of("0x0");
        List<Long> numbers = List.of(0x0L);
    ...
    public void testArbitrarySingleByte() {
        List<String> expected = List.of("0x40");
        List<Long> numbers = List.of(0x40L);
    ...
    public void testLargestSingleByte() {
        ...
        List<Long> numbers = List.of(0x7fL);
    ...
    public void testSmallestDoubleByte() {
        ...
        List<Long> numbers = List.of(0x80L);
    ...
    public void testArbitraryDoubleByte() {
        ...
        List<Long> numbers = List.of(0x2000L);
    ...
    public void testLargestDoubleByte() {
        ...
        List<Long> numbers = List.of(0x3fffL);
    ...
    public void testSmallestTripleByte() {
        ...
        List<Long> numbers = List.of(0x4000L);
    ...
    public void testArbitraryTripleByte() {
        ...
        List<Long> numbers = List.of(0x100000L);
    ...
    public void testLargestTripleByte() {
        ...
        List<Long> numbers = List.of(0x1fffffL);
    ...
    public void testSmallestQuadrupleByte() {
        ...
        List<Long> numbers = List.of(0x200000L);
    ...
    public void testArbitraryQuadrupleByte() {
        ...
        List<Long> numbers = List.of(0x8000000L);
    ...
    public void testLargestQuadrupleByte() {
        ...
        List<Long> numbers = List.of(0xfffffffL);
    ...
    public void testSmallestQuintupleByte() {
        ...
        List<Long> numbers = List.of(0x10000000L);
    ...
    public void testArbitraryQuintupleByte() {
        ...
        List<Long> numbers = List.of(0xff000000L);
    ...
    public void testMaximum32BitIntegerInput() {
        ...
        List<Long> numbers = List.of(0xffffffffL);
